...
to setup
  ...
  ask n-of 5 patches [ set pcolor grey ]
...
to make-model
  ...
  [
    set shopping-pos []
    if [pcolor] of patch x-pos y-pos = orange
    [
      if (member? "Orange" shopping-list) and not (member? "Orange" shopping-cart)
    [
        set shopping-cart lput "Orange" shopping-cart
      set shopping-pos lput x-pos shopping-pos
      set shopping-pos lput y-pos shopping-pos
      set model lput shopping-pos model
    ]]
    if [pcolor] of patch x-pos y-pos = red
    [
    ...
    if [pcolor] of patch x-pos y-pos = green
    [
    ...
    if [pcolor] of patch x-pos y-pos = blue
    [
    ...
    if [pcolor] of patch x-pos y-pos = yellow
    [
    ...
    if [pcolor] of patch x-pos y-pos = white
    [
