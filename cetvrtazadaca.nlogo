...
globals [ bz pz bm pm cilj ruta
          cestarine brzine kraj rnd rndCest]
...
to random-function
  ...
  repeat 3 [
    set rnd ((random 80) + 40)
    set rndCest ((random 3) + 1 )
    set brzine lput rnd brzine
    set cestarine lput rndCest cestarine
