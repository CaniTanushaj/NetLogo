...
to setup
  ...
  [
    ...
    if (random 2) = 1 [
    set shopping-list lput "Orange" shopping-list

    ]
    if (random 2) = 1 [
    set shopping-list lput "Red" shopping-list
    ]
    if (random 2) = 1 [
    set shopping-list lput "Green" shopping-list
    ]
    if (random 2) = 1 [
    set shopping-list lput "Blue" shopping-list
    ]
    if (random 2) = 1 [
    set shopping-list lput "Yellow" shopping-list
    ]
    if (random 2) = 1 [
    set shopping-list lput "Grey" shopping-list
    ]
    if (random 2) = 1 [
    set shopping-list lput "White" shopping-list
    ]
    setxy -8 -6
    set heading 90
    show shopping-list
  ...
  ; stvaranje "asortimana" trgovine
  ask n-of (random  10) patches[ set pcolor orange ]
  ask n-of (random  10) patches [ set pcolor red ]
  ask n-of (random  10) patches [ set pcolor green ]
  ask n-of (random  10) patches [ set pcolor blue ]
  ask n-of (random  10) patches [ set pcolor yellow ]
  ask n-of (random  10) patches [ set pcolor grey ]
  ask n-of (random  10) patches[ set pcolor white ]
end
